...
SVM implements a very simplistic stack machine. It has a stack (containing
only numbers)
and a "central memory" that is adressable by names instead of adresses (think
"variables"...)
...
The format of svm's "bytecode" is the following:
    ...
    NB: whitespace is not significant in bytecode files. The identation above
